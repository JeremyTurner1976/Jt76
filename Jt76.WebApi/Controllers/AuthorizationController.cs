namespace Jt76.WebApi.Controllers
{
	...
	public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Exchange(OpenIdConnectRequest request)
        {
            ...
            {
                ApplicationUser user = await _userManager.FindByEmailAsync(request.Username) ?? await _userManager.FindByNameAsync(request.Username);
                if (user == null)
                {
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync(OpenIdConnectRequest request, ApplicationUser user)
        {
            ...
            AuthenticationTicket ticket = new AuthenticationTicket(principal, new AuthenticationProperties(), OpenIdConnectServerDefaults.AuthenticationScheme);
