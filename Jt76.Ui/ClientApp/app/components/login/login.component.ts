...
export class LoginComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		setTimeout(() => {
			this.alertService.showMessage("Hello tester!", "Please login with any of the demo credentials below", MessageSeverity.info);
			this.alertService.showStickyMessage("Admin User", "Username: admin<br />Password: tempP@ss123", MessageSeverity.default);
			this.alertService.showStickyMessage("Standard User", "Username: user<br />Password: tempP@ss123", MessageSeverity.default);
		}, 3500);
	}
