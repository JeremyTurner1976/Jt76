namespace Jt76.Data.ComplexModels.IdentityCore
{
	using System;
    ...
    {
        private readonly Jt76IdentityDbContext _context;
        private readonly Jt76ApplicationDbContext _appContext;
		private readonly UserManager<ApplicationUser> _userManager;
        private readonly RoleManager<ApplicationRole> _roleManager;


        public AccountManager(Jt76IdentityDbContext context, Jt76ApplicationDbContext appContext, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        public async Task<bool> TestCanDeleteUserAsync(string userId)
        {
			...
			if (await _appContext.Errors.Where(x => x.CreatedBy == userId).AnyAsync())
				return false;
